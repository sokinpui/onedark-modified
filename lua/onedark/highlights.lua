...
hl.common = {
    ...
    FoldColumn = {fg = c.comment, bg = cfg.transparent and c.none or c.bg1, fmt = "underline"},
    Folded = {fg = c.comment, bg = cfg.transparent and c.none or c.bg1, fmt = "underline"},
    ...
    DiffText = {fg = c.purple, bg= c.none, fmt = "reverse,underline"},
    ...
    CurSearch = {fg = c.puredark, bg = c.orange, fmt = "bold,italic"},
    IncSearch = {fg = c.bg1, bg = c.yellow, fmt = "bold,italic"},
    Search = {fg = c.puredark, bg = c.blue, fmt = "bold,italic"},
    Substitute = {fg = c.bg0, bg = c.green},
    MatchParen = {fg = c.match_red, bg = c.bg1, fmt = "bold"},
    NonText = {fg = c.grey},
    ...
    TabLine = {fg = c.fg, bg = c.bg3},
    TabLineFill = {fg = c.grey, bg = c.bg3},
    TabLineSel =  {fg = c.cyan, bg = c.bg3},
    VertSplit = {fg = c.bg3},
    Visual = {bg = c.visual_green},
...
hl.syntax = {
    ...
    Comment = {fg = c.comment, fmt = "bold,italic"},
    SpecialComment = {fg = c.comment, fmt = "bold,italic"},
...
hl.langs.html = {
    htmlBlockquote = colors.Comment,
    htmlBold = {fg = c.yellow, fmt = "bold"},
    htmlBoldItalic = {fg = c.yellow, fmt = "bold,italic"},
    htmlBoldDelimiter = colors.Fg,
    htmlCode = colors.Green,
    htmlCodeBlock = colors.Green,
    htmlCodeDelimiter = colors.Yellow,
    htmlH1 = {fg = c.red, fmt = "bold"},
    htmlH2 = {fg = c.purple, fmt = "bold"},
    htmlH3 = {fg = c.orange, fmt = "bold"},
    htmlH4 = {fg = c.red, fmt = "bold"},
    htmlH5 = {fg = c.purple, fmt = "bold"},
    htmlH6 = {fg = c.orange, fmt = "bold"},
    htmlHeadingDelimiter = colors.Red,
    htmlHeadingRule = colors.Red,
    htmlId = colors.Yellow,
    htmlIdDeclaration = colors.Red,
    htmlItalic = {fg = c.yellow, fmt = "italic"},
    htmlItalicDelimiter = {fg = c.fg, fmt = "italic"},
    htmlLinkDelimiter = colors.Purple,
    htmlLinkText = colors.blue,
    htmlLinkTextDelimiter = colors.Fg,
    htmlListMarker = colors.Red,
    htmlOrderedListMarker = colors.Red,
    htmlRule = colors.Purple,
    htmlUrl = {fg = c.cyan, fmt = "underline"},
    htmlUrlDelimiter = colors.Fg,
    htmlUrlTitleDelimiter = colors.Green
}

hl.langs.markdown = {
    markdownBlockquote = colors.Comment,
    markdownBold = {fg = c.yellow, fmt = "bold"},
    markdownBoldItalic = {fg = c.yellow, fmt = "bold,italic"},
    markdownBoldDelimiter = colors.Fg,
    ...
    markdownHeadingDelimiter = colors.Red,
    markdownHeadingRule = colors.Red,
    markdownId = colors.Yellow,
    markdownIdDeclaration = colors.Red,
    markdownItalic = {fg = c.yellow, fmt = "italic"},
    markdownItalicDelimiter = {fg = c.fg, fmt = "italic"},
    markdownLinkDelimiter = colors.Purple,
    markdownLinkText = colors.blue,
    markdownLinkTextDelimiter = colors.Fg,
    ...
    markdownUrlDelimiter = colors.Fg,
